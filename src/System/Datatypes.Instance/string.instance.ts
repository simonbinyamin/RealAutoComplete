...
export const StringInstanceDisposable = vscode.languages.registerCompletionItemProvider(
    'csharp',
    {
        provideCompletionItems(document: vscode.TextDocument, position: vscode.Position) {
            ...
            if (document.getText().includes("string ") || document.getText().includes("String ")) {
            ...
            var Methods = json.System.DatatypesInstance.string.Methods as string[];
